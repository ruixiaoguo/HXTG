...
@implementation HXCustomStrateCell
...
-(void)gaintLineTalkList
{
    ...
    [[HXNetClient sharedInstance]NetRequestPOSTWithRequestURL:@"app/CustomStrategies" WithParameter:dict WithReturnValeuBlock:^(NSURLSessionDataTask *task, NSDictionary *responseDict) {    [HXLoadingView show];
