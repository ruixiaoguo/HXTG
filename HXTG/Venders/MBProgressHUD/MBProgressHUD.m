...
- (void)layoutSubviews {
	...
	CGRect labelF;
#pragma mark - =============================修改背景框文本高度====================================
	labelF.origin.y = yPos-4;
...
#pragma mark - =====================修改背景框的颜色===========================================
    if (self.color) {
        CGContextSetFillColorWithColor(context, self.color.CGColor);
    } else {
        CGContextSetGrayFillColor(context, 0.0f, self.opacity);
//        CGContextSetRGBFillColor(context,222/255.0,62/255.0,68/255.0,self.opacity);
    }

#pragma mark - =====================修改背景框的高度圆角===========================================
	CGRect allRect = self.bounds;
	// Draw rounded HUD backgroud rect
	CGRect boxRect = CGRectMake(roundf((allRect.size.width - size.width) / 2) + self.xOffset,
								roundf((allRect.size.height - size.height) / 2) + self.yOffset, size.width, size.height-10);
	float radius = 6.0f;
